...
\begin{center}
\vspace{-0.4cm}
\includegraphics[width=0.64\linewidth]{Ingerimm_ph}
\vspace{-0.5cm}
\end{center}
...
Damit ist ein Rededuell (\ilaris{55}) mit DG~2 begonnen:
}
\spaltenende
...
Es muss sich um \textbf{Rattengold} handeln, eines der sogenannten 13 Unmetalle.\\
	...
	\textbf{28:} Rattengold lässt sich für einige \textbf{Alchemika} verwenden, beispielsweise als potentes Substitut für Gold und Bernstein im \textbf{Bannstaub} (\ilaris{64}) oder für Zinnober im \textbf{Purpurblitz} (\ilaris{66}).\\
