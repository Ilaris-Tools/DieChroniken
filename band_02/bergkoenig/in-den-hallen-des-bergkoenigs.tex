...
Den Schauplatz Finsterkoppen und die Finsterkopp-Binge war schon im Computerspiel \emph{Sternenschweif} (Attic, 1994) zu erkunden. %, das ich vor etwa 20 Jahren das letzte Mal gespielt habe.
...
erfolg={Die Gruppe wird beauftragt, in die Binge hinabzusteigen.
	Inradon \textbf{Xermosch} persönlich geleitet sie vor das goldene Tor und überreicht Ihnen den Schlüssel:
...
Der Misserfolg führt bei diesen Wegen zu einem Betretungsverbot des Tempels für alle Beteiligten (wenn auch nur für die nächsten 3x3 Jahrzehnte).
...
Es muss sich um \textbf{Rattengold} handeln, eines der sogenannten 13 Unmetalle.\\
	...
	\textbf{24:} Rattengold lässt sich für einige \textbf{Alchemika} verwenden, beispielsweise als potentes Substitut für Gold und Bernstein im \textbf{Bannstaub} \emph{(Ilaris:64)} oder für Zinnober im \textbf{Purpurblitz} (\emph{Ilaris:66}).\\
	\textbf{28:} Es heißt, dass der \textbf{Kaisertöter} -- eine mythische Klinge, mit der der Kult des Namenlosen Herrscherhäuser stürzt -- aus Rattengold geschmiedet wird.}
\spaltenanfang


\subsubsection{Die Wühlschrate}
Eine Sippe von \textbf{Wühlschraten} hat sich aus der Tiefe auf die Höhe der Zwergentunnel vorgearbeitet.
...
\paragraph{\textbf{Wie ein Sembelquast}}
...
Der Öffnungsmechanismus befindet sich in der Mitte: Drei Räder sind so in das Portal eingelassen, dass sie jeweils eine Rogolan-Rune zeigen. Sie lassen sich drehen; das gesamte zwergische Alfabet ist auf ihnen dargestellt.
...
erfolg={Die Anordnung der Paneele erinnert an die Runen hinter dem \textbf{Angrosch-Altar} auf der ersten Ebene.\\
	\textbf{16:} Die drei Sorten Runen entsprechen den Buchstaben des Namens Angrosch und geben damit eine Reihenfolge (1.\,N 2.\,GR 3.\,SCH)vor.\\
...
\label{zuruck}
\vorlesen{Als ihr das \textbf{Rattengold} passiert, fällt euch auf, dass der Brocken von der Mitte des Gangs verschwunden ist. Als ihr euch umseht, findet ihr stattdessen einen handtellergroßen goldenen \textbf{Knopf} von zwergischer Machart.}
...
\info{Stimmen Sie mit der Gruppe ab, von wo diese das Ritual miterleben wollen:
	...
	Andere können ehrenhalber einen der begehrten Plätze im Tempel einnehmen. Wer sich irgendwann dem Vertrauen des \fkvs als unwürdig erwiesen hat, wird wohl in der Halle ganz hinten stehen müssen -- ein interessanter Ausgangspunkt für die \emph{Verfolgungsjagd}.}
\vorlesen{%
...
Der Inradon, den Serpentin in Händen, leitet sie zum großen Altar-Amboss. Danach greift er zum Hammer: \enquote{Mit den Schlägen dieses Werkzeugs werden wir unsere Zukunft in deine Hände legen, oh einziger Gott unseres Volkes.}
}
\subsubsection{Die Enttarnung des Bösewichts}
\probe{Wahrnehmung}{Wachsamkeit (16)}{\emph{keine Zusammenarbeit möglich.} Einer mitschmiedenden Figur fällt auf, dass das geschmolzene Zwergengold in einer der Schalen in Bewegung gerät. Wer weiter entfernt steht, bemerkt stattdessen, dass die Knöpfe an Bonderiks Robe dem gefundenen gleichen.}
...
% \includepdf[pages=-,addtotoc={1,section,1,Jasinthe,sc1}]{bergkoenig/pdf/jasinthe.pdf}
% \includepdf[pages=-,addtotoc={1,section,1,Odir Sensendengler,sc1}]{bergkoenig/pdf/odir_sensendengler.pdf}
% \includepdf[pages=-,addtotoc={1,section,1,Graboxa,sc1}]{bergkoenig/pdf/graboxa.pdf}
\includepdf[pages=-,addtotoc={1,section,1,Beispielcharaktere,hdbscs}]{bergkoenig/pdf/dascha.pdf}
\includepdf[pages=-]{bergkoenig/pdf/jasinthe.pdf}
\includepdf[pages=-]{bergkoenig/pdf/odir_sensendengler.pdf}
\includepdf[pages=-]{bergkoenig/pdf/graboxa.pdf}
