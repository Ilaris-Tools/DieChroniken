...
\emph{Vanjescha Stoerrebrandt}, Leiterin des Kontors in \emph{Tjolmar}, plant den Ausbau der Handelsstraße von Tjolmar nach \emph{Riva}.
...
Jagdregeln für Ilaris stehen im Regelwerk auf S. 68. Die Basis bilden dabei Proben auf \begriff{Überleben}.
...
Recherche: Das Geheimnis von Jokmanns Wein (Dauer: 3 Stunden;
...
{
Ermittlung: Wo sind die Wildschweinfässer? (Dauer: 2 Stunden;
...
{
Recherche: Geschichten über den Qualmgeist (Dauer: 5 Stunden;
...
\absatz{Goblins}
Die Goblinsippe unter der Führung ihrer Schamanin \emph{Aschka der Verhüllten} siedelt seit Jahrhunderten in der Region zwischen dem Rorwhed und dem Odenmoor.
Allerdings ist es nicht der Wein, der das Jagdglück bringt, sondern die Karaffe, aus der er getrunken wird.
Denn auf dieser liegt ein \begriff{Adlerauge Luchsenohr}  (Ilaris, S.\,130), der die Wahrnehmung der Jäger erhöht.
...
Der Eulenhexer Bringimox sorgt sich dagegen mehr um das Loch in den Feenpfaden.
...
Ein Vogelknochen, auf welchem ein Zauber liegt. Zerbricht man ihn, löst das einmalig einen \begriff{Krähenruf} aus (Ilaris, S.\,134).
