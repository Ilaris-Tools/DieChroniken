...
\includepdf[pages=-,addtotoc={1,section,1,Melcher,nsc8}]{asche_im_wind/charaktere/melcher.pdf}
\includepdf[pages=-,addtotoc={1,section,1,Roana Wildfang,nsc9}]{asche_im_wind/charaktere/roana_wildfang.pdf}
\includepdf[pages=-,addtotoc={1,section,1,Wiesel-Rupo,nsc10}]{asche_im_wind/charaktere/wiesel_rupo.pdf}
\neueseite
\mithintergrund