...
Nach drei Stunden erreichen die Charaktere dann \textbf{Wengenholm}, welches eine halbe Meile unterhalb der Mündung der \textbf{Wenge} in die \textbf{Ange} unterhalb der immer noch imposanten Ruine der \textbf{Angenburg} ruht.
\textbf{Wengenholm} selbst hat etwa 350 Einwohner und ist mit einer soliden Palisade umzäunt.
...
\probe{gebraeuche}{Gebräuche (12)}{
    Alternativ: \textit{Menschenkenntnis} oder \textit{Überreden}. 
    Dauer: eine halbe Stunde
}

Bei Misslingen kann die Probe beliebig oft wiederholt werden.
Die Charaktere verlieren allerdings jeweils ein wenig Zeit, da sie sich im Ort umhören müssen.
...
Sollten die Räuber die Charaktere haben hören können, so haben sie ihre Waffen in der Hand (Holzspeer oder Knüppel), Grimma zielt kniend mit ihrem Kurzbogen auf sie.
...
Der sympathische Gehilfe des Peraine-Tempels zu Boggerode entspricht mit seinem vollen, schwarzen Haaren und dem dichten Vollbart ganz dem Bild des typischen Koschers.
