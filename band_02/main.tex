...
% get rid of some repeating errors/warnings
% \usepackage{silence}
% \WarningsOff[hyperref] % Suppress warnings from the hyperref package
% \WarningsOff[font]     % Suppress font warnings
% \hbadness=10000 % Suppress underfull hbox warnings
% \vbadness=10000 % Suppress underfull vbox warnings
% \hfuzz=1pt      % Suppress overfull hbox warnings up to 1pt
% \vfuzz=1pt      % Suppress overfull vbox warnings up to 1pt
...
% TODO: hab ich nur ergaenzt weil die commands fehlten, wo sollten die stehen?
%\newcommand{\mprobe}[4]{\probe{#1}{#2}{#3}{#4}}
%\newcommand{\texticon}[1]{\icon{#1.png}}
...
\credit{Illustrationen}{
	...
	% Norman Obst\\
	% René Dudziak\\
	\href{https://de.wiki-aventurica.de/wiki/Ramona_von_Brasch}{Ramona von Brasch}\\
	...
	\href{https://www.nga.gov/}{National Gallery of Art}
}	
\credit{\LaTeX-Klasse}{
...
\zeichnung[\linewidth]{offene_lizenz/rome_20_4}
...
Ist \textit{Zusammenarbeit} (\ilaris{8}) erlaubt \texticon{probe_zusammenarbeit_ja} oder nicht \texticon{probe_zusammenarbeit_nein}?
Handelt es sich um eine \textit{Gruppenprobe} (\ilaris{8}), bei der der beste \texticon{probe_gruppenprobe_gut} (Pfeil oben), oder der schlechteste Charakter \texticon{probe_gruppenprobe_schlecht} (Pfeil unten) würfelt,
oder ist es gar keine Gruppenprobe \texticon{probe_gruppenprobe_nein}?
Wird mit 3W20 \texticon{wuerfel_rot_3} oder 1W20 \texticon{wuerfel_rot_1} gewürfelt - dabei wird auch direkt die Schwierigkeit angegeben, wenn es sich um eine offene Probe handelt.
Proben mit einem Detailgrad über eins \texticon{probe_detailgrad_1} (\ilaris{9}) sind \textit{ausgedehnte Proben} mit Detailgrad zwei \texticon{probe_detailgrad_2}, drei \texticon{probe_detailgrad_3} oder sogar vier \texticon{probe_detailgrad_4}.
Zuletzt wird noch angegeben, ob eine \textit{offene Probe} \texticon{probe_vergleichend_nein} oder eine \textit{vergleichende Probe} \texticon{probe_vergleichend_ja} gewürfelt wird (\ilaris{9}).
Ein Beispiel:
...
\chapter*{\href{https://ilaris-online.de/app/abenteuer/7e77091f-0602-494e-8c89-0ae840704ced}{Die schwarze\linebreak Hand im Wengen\-holmer Land}} % TODO
...
\begin{center}
\zeichnung[0.67\textwidth]{cover-bergkoenig.png}\\
...
% Back cover with proper formatting (in libre office: backcover.odt)
