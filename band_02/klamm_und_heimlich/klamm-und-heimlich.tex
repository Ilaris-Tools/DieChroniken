...
\info{Immer dann, wenn jemand ein Wagnis unternimmt, kannst du eine Probe verlangen:\\
Die betreffende Person würfelt dazu drei zwanzigseitige Würfel (3W20), von denen nur das mittlere Ergebnis gewertet wird, und addiert ihren Probenwert (PW) von Heimlichkeit. Das Ergebnis muss den Zielwert von 12 erreichen, damit die Aktion glückt.}
...
\zeichnung[0.3\textwidth]{Goblin-Tusche_f2_2}
...
\spaltenende
\begin{center}
\includegraphics[width=0.31\linewidth]{oger}
\end{center}