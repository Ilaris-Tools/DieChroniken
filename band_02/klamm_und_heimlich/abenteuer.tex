...
\kreatur{Greifax}{\enquote{Mächtiger} Meckerdrache}{mythen}{
	\label{greifax}
    \kreaturkampfwerte{12}{8}{1, fliegend 12}{5}
    \trennlinie
	\kreaturattribute{KK 6, KO 6, KL 4, IN 8, FF 2, GE 4, MU 4}
    \trennlinie
    \kreaturwaffe{Klauen}{0}{6}{10}{2W6+1}{Sturmangriff (max +6)}
...
\kreatur{Ork-Schamane}{Shurrak Windzahn, Schamane des Schwarzen Banners}{humanoid}{
	...
	\textit{Vorbereitungszeit verkürzen} (Regelwerk S. 71) von 16 auf 8 Aktionen.}
}
...
\neueseite
\ohnehintergrund
\includepdf[pages=-,addtotoc={1,section,1,Beispielcharaktere,kuhscs}]{klamm_und_heimlich/charaktere/arion_nebelsucherin.pdf}
\includepdf[pages=-]{klamm_und_heimlich/charaktere/donata_donnerschlag.pdf}
\includepdf[pages=-]{klamm_und_heimlich/charaktere/elidir_fenius_galahan.pdf}
\includepdf[pages=-]{klamm_und_heimlich/charaktere/karox_sohn_des_kalgrix.pdf}
\includepdf[pages=-]{klamm_und_heimlich/charaktere/selindian_der_wuerstchenspalter.pdf}
\neueseite
\mithintergrund